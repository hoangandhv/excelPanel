...
public class ExcelPanel extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    protected TextView titleExpanel;
    ...
    public ExcelPanel(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            textTitle = (String) a.getString(R.styleable.ExcelPanel_title);
        } finally {
            a.recycle();
        }
    ...
    private void initWidget() {
        ...
        titleExpanel = new TextView(getContext());
        addView(titleExpanel, new LayoutParams(leftCellWidth, topCellHeight));
        LayoutParams txt = (LayoutParams) titleExpanel.getLayoutParams();
        titleExpanel.setLayoutParams(txt);
        titleExpanel.setBackground(getContext().getDrawable(R.drawable.bg_text_excel));
        titleExpanel.setTextColor(Color.WHITE);
        titleExpanel.setText(textTitle);
        titleExpanel.setGravity(Gravity.CENTER);
